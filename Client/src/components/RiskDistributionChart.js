      ...
      <div className="donut-chart-container">
        <div className="donut-relative-wrapper">
          <svg width="200" height="200" viewBox="0 0 200 200" className="donut-svg">
            <circle cx="100" cy="100" r="70" fill="transparent" stroke="var(--border-color)" strokeWidth="18" />
            {donutSegments.map((seg) => (
              <circle
                ...
                style={{ transition: "stroke-width var(--transition-fast), stroke var(--transition-fast)", cursor: "pointer" }}

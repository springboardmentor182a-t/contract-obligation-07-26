...
const categories = ['Contract', 'Approval', 'Security', 'Change'];
...
export default function AuditLogs() {
  ...
  return <div className="audit-dashboard fade-in">
    <div className="audit-page-header"><div><h1>Audit Management</h1><p>Track system approvals, security events, and change history.</p></div><div className="audit-header-actions"><Button variant="outline" icon={Download} onClick={() => handleExport('csv')}>Export CSV</Button><Button variant="primary" icon={Download} onClick={() => handleExport('pdf')}>Export report</Button></div></div>

...
const RenewalAIRecommendation = () => {
  ...
  return (
    <div className="ai-rec-container fade-in">
          ...
          <div className="main-rec-content">
            ...
            <div className="rec-metrics">
              ...
              <div className="metric-box">
                ...
                <div className="metric-value-container">
                  <span className="metric-value">{recommendation.days_until_expiry}</span>
                </div>
              </div>
            </div>
      ...
      {/* Footer Info */}
      <div className="ai-footer-info" style={{ alignItems: 'flex-start', flexDirection: 'column' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
          <Info size={16} style={{ marginTop: '4px' }} />
          <p>{recommendation.source_message || "This recommendation is generated by ContractIQ AI based on current renewal parameters, historical approvals, and contract configuration. It is intended to assist human decision-making, not replace it."}</p>
        </div>
        {recommendation.ai_error && (
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', color: 'var(--danger)' }}>
            <AlertTriangle size={16} style={{ marginTop: '4px' }} />
            <p style={{ fontSize: '0.9em', wordBreak: 'break-word', margin: 0 }}><strong>Error Details:</strong> {recommendation.ai_error}</p>
          </div>
        )}
      </div>
    </div>

...
def summary(db: Session):
    ...
    return {
        "total": len(rows),
        "categories": {
            name: sum(row[0] == name for row in rows) for name in categories
        },
    }
...
def seed_audit_data(db: Session):
    ...
    records = [
        (
            ...
            "User",
            "USR-101",
            "Successful sign-in from company network",
            "Success",
        ),
        (
            "James Wilson",
            ...
            "Contract",
            "CNT-2025-001",
            "Viewed Microsoft Azure Enterprise Agreement",
            "Success",
        ),
        (
            "Emily Davis",
            ...
            "Contract",
            "CNT-2025-004",
            "Updated Oracle Database Enterprise License value",
            "Success",
        ),
        (
            "Michael Brown",
            ...
            "Obligation",
            "OBL-218",
            "Marked quarterly security review as completed",
            "Success",
        ),
        (
            "Legal Department",
            ...
            "Renewal",
            "CNT-2025-010",
            "Approved Zoom Enterprise Video Platform renewal",
            "Success",
        ),
        (
            "Finance Director",
            ...
            "Renewal",
            "CNT-2025-011",
            "Rejected SAP S/4HANA Cloud License renewal budget",
            "Warning",
        ),
        (
            "System",
            ...
            "User",
            "USR-104",
            "Failed login attempt for David Martinez",
            "Warning",
        ),
        (
            "Sarah Chen",
            ...
            "User",
            "USR-118",
            "Changed analyst role to Contract Manager",
            "Success",
        ),
        (
            "Lisa Anderson",
            ...
            "Contract",
            "CNT-2025-016",
            "Created DocuSign enterprise contract",
            "Success",
        ),
        (
            "Robert Taylor",
            ...
            "Contract",
            "CNT-2024-089",
            "Archived expired vendor agreement",
            "Success",
        ),
        (
            "Compliance Officer",
            ...
            "Compliance",
            "CMP-009",
            "Reviewed GDPR processing requirement",
            "Success",
        ),
        (
            "System",
            ...
            "User",
            "USR-122",
            "Blocked unauthorised user-management access",
            "Warning",
        ),
    ]
    for index, item in enumerate(records * 2):
        user, action, module, category, entity_type, entity_id, description, status = (
            item
        )
        ...
        db.add(
            AuditLog(
                ...
                old_value=(
                    '{"status": "Pending"}'
                    if category in ("Change", "Approval")
                    else None
                ),
                new_value=(
                    '{"status": "Completed"}'
...
def export_logs(logs, report_format):
    if report_format.lower() == "pdf":
        ...
        pdf.drawString(45, 755, "ContractIQ Audit Report")
        ...
        for log in logs:
            ...
            if y < 45:
                ...
                y = 755
        pdf.save()
        return buffer.getvalue(), "application/pdf", "audit-report.pdf"
    output = io.StringIO()

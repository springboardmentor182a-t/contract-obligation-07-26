...
def generate_renewal_recommendation(
    ...
    try:
        ...
        return {
            ...
            "source_message": (
                "This recommendation was generated by the AI model."
                if ai_generated
                else "AI model failed to generate a valid recommendation, "
                "so this recommendation was generated using manual fallback rules."
            ),
        }
        ...
        fallback.update(
            {
                ...
                "ai_generated": False,
                "source_message": (
                    "AI model encountered an error, so this recommendation "
                    "was generated using manual fallback rules."
                ),
                "ai_error": str(e),
            }
        )

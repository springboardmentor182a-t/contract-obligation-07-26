  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (
        ...
        !quickActionRef.current.contains(event.target)
      ) {
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <div className="hidden lg:flex items-center gap-2 text-sm font-medium text-gray-500 dark:text-gray-400">
          <span
            ...
            className="hover:text-gray-700 dark:hover:text-gray-200 cursor-pointer transition-colors"
          >
            ContractIQ
          </span>
                ...
                {recentNotifications.length > 0 ? (
                  recentNotifications.map((n) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm ${s.bg} ${s.color}`}
                        >
          ...
          {quickActionDropdown && (
            <div className="absolute right-0 mt-3 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 py-2 z-50 animate-in fade-in slide-in-from-top-2">
              <button
                ...
                className="w-full text-left px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
              >
                New Contract
              </button>

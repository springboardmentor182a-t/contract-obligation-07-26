    ...
    <>
      ...
      `}>
        ...
        <nav className="flex-1 pb-4">
          ...
          <Link to="/audit-logs" onClick={() => setIsOpen(false)} className={`${linkClass} ${isActive('/audit-logs')}`}>
            <div className="p-2 rounded-lg bg-violet-500/10 text-violet-400 group-hover:bg-violet-500/20 group-hover:scale-110 transition-all mr-4">
